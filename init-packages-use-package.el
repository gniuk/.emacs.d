...
(load "~/.emacs.d/packages-use-package.el")
...
(use-package company
  :ensure t
  :defer t
  :defines (company-sort-by-occurrence company-dabbrev-downcase company-dabbrev-ignore-case)
  :init
  (add-hook 'after-init-hook #'global-company-mode)
  :hook                                 ;; https://ladicle.com/post/config/
  ((c++-mode
    c-mode
  ...
  ((js-mode
    js2-mode). (lambda () (set (make-local-variable 'company-backends)
                               '((company-yasnippet
                                  company-tern
                                  company-files)))))
  ...
  (use-package company-anaconda :ensure t :defer t
    ...
    :bind (("M-s" . anaconda-mode-find-assignments))
  ...
  (setq company-minimum-prefix-length 1
        ...
        company-sort-by-occurrence 1
        company-tooltip-limit 14
        company-idle-delay 0.2
        company-begin-commands '(self-insert-command)
        company-selection-wrap-around t               ; make previous/next selection cycle style
        company-dabbrev-downcase nil
        company-dabbrev-ignore-case nil
        ;company-tooltip-align-annotations t
        company-require-match nil)
  ;(remove 'company-semantic company-backends)
  ;; show doc via popup, only working in gui
...
(use-package goto-last-change
  :ensure t
  :defer t
  :bind (("C-c l l" . goto-last-change-with-auto-marks)))
...
(use-package helm-projectile
  :ensure t
  :defer t
  :bind (("C-x p f" . helm-projectile-find-file-dwim)
...
;;; here, show the current function which the cursor is in
(which-function-mode t)

;;; rtags
(use-package rtags
  :defer t
  ;:hook ((asm-mode c-mode c++-mode objc-mode) . rtags-mode)
  :custom
...
(use-package multiple-cursors
  ...
  :ensure t
  :defer t
  :bind (("C-c m a" . mc/mark-all-in-region)
         ("M-9" . mc/mark-next-like-this)
         ("M-8" . mc/edit-lines)))
...
(use-package smooth-scrolling
  :ensure t
  :defer t
  :custom (smooth-scroll-count-lines 3)
